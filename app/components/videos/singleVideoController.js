...
.controller('singleVideoController', ['$scope', '$http', '$rootScope', '$window', '$state', '$stateParams','$sce',

	function ($scope, $http, $rootScope, $window, $state, $stateParams, $sce) {
