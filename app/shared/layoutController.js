angular
  ...
  .controller("main_headerCtrl", [
    ...
    function(
      ...
      $scope.user_id =
        memoryStorage.user_id != "" && memoryStorage.user_id != undefined
          ? memoryStorage.user_id
          : false;

      $scope.access_token =
        memoryStorage.access_token != undefined &&
      ...
      if ($scope.user_id && $scope.access_token) {
        ...
        var site_logo = $.grep($rootScope.site_settings, function(e) {
          return e.key == "site_logo";
        });
        ...
        if (
          $stateParams.sub_profile_id == undefined ||
          $stateParams.sub_profile_id == ""
        ) {
        ...
        $scope.user_picture =
          memoryStorage.user_picture != "" &&
          memoryStorage.user_picture != undefined
            ? memoryStorage.user_picture
            : "img/model3.jpg";

        $scope.user_name =
          memoryStorage.user_name != "" && memoryStorage.user_name != undefined
            ? memoryStorage.user_name
            : "";
        ...
        function notifications() {
          $.ajax({
            ...
            data: {
              id: memoryStorage.user_id,
              token: memoryStorage.access_token,
              sub_profile_id: $scope.sub_profile_id
            },
        ...
        var socket_url = $.grep($rootScope.site_settings, function(e) {
          return e.key == "socket_url";
        });
        ...
        if (get_socket_url == "") {
          UIkit.notify({
            message: "Configure Socket Url, Please Contact Admin",
            timeout: 3000,
            pos: "top-center",
            status: "danger"
          });
  ...
  .controller("footerCtrl", [
    ...
    function($scope, $http, $rootScope, $window, $state) {
      ...
      var appstore = $.grep($rootScope.site_settings, function(e) {
        return e.key == "appstore";
      });
      ...
      var playstore = $.grep($rootScope.site_settings, function(e) {
        return e.key == "playstore";
      });
      ...
      var facebook_link = $.grep($rootScope.site_settings, function(e) {
        return e.key == "facebook_link";
      });
      ...
      if (facebook_link.length == 0) {
        ...
        if (
          facebook_link_url != "" ||
          facebook_link_url != null ||
          facebook_link_url != undefined
        ) {
        } else {
          facebook_link_url = "";
        }
      ...
      var linkedin_link = $.grep($rootScope.site_settings, function(e) {
        return e.key == "linkedin_link";
      });
      ...
      var twitter_link = $.grep($rootScope.site_settings, function(e) {
        return e.key == "twitter_link";
      });
      ...
      if (twitter_link.length == 0) {
        ...
        if (
          twitter_link_url != "" ||
          twitter_link_url != null ||
          twitter_link_url != undefined
        ) {
        } else {
          twitter_link_url = "";
        }
      ...
      var google_plus_link = $.grep($rootScope.site_settings, function(e) {
        return e.key == "google_plus_link";
      });
      ...
      if (google_plus_link.length == 0) {
        ...
        if (
          ...
          google_plus_link_url != null ||
          google_plus_link_url != undefined
        ) {
        } else {
          google_plus_link_url = "";
        }
      ...
      var pinterest_link = $.grep($rootScope.site_settings, function(e) {
        return e.key == "pinterest_link";
      });
      ...
      if (pinterest_link.length == 0) {
        ...
        if (
          pinterest_link_url != "" ||
          pinterest_link_url != null ||
          pinterest_link_url != undefined
        ) {
        } else {
          pinterest_link_url = "";
        }
